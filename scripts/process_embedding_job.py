"""Process one pending embedding job with the mock embedding worker."""
...
from app.core.embedding_worker import process_next_mock_embedding_job  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--worker-name", default="mock-embedding-worker")
